...
public class FuncionarioServiceTest {
	...
	public void setUp() throws Exception {
		...
		BDDMockito.given(this.funcionarioRepository.findOne(Mockito.anyString())).willReturn(new Funcionario());
	...
	public void testBuscarFuncionarioPorId() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorId("1");
